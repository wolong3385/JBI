function [results]=CBOS_sampling_holdout(Train,Test,data_sample,clvalue,knnk);
...
cbos_data=CBOS(Train_data); % here IR=1, means 200% oversampling
TrainingSample=cbos_data(:,1:end-1);
TrainingLabel=cbos_data(:,end);
