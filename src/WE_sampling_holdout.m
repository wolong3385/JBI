function [results]=WE_sampling_holdout(Train,Test,data_sample,clvalue,knnk);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 we_data=WE(Train_data); % here IR=1, means 200% oversampling
TrainingSample=we_data(:,1:end-1);
TrainingLabel=we_data(:,end);
